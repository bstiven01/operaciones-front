...
@Component({
  selector: 'app-cargue-matriz-distancia',
  templateUrl: './cargue-matriz-distancia.component.html',
  styleUrls: ['./cargue-matriz-distancia.component.scss']
})
export class CargueMatrizDistanciaComponent implements OnInit {
  ...
  insertarProgramacionSemanal() {
    this._cargueService.validarArchivoMatrizDistancia(this.selectedFile).subscribe(
      (resp:Mensaje) => {
        this.spinner.hide();
